...
void loop () {
  ...
  inv_1_fwd(10*SEC, false);     // timing works with seconds
  inv_1_rev(10*SEC, true); 
  inv_1_rev(20*SEC, false);
  
  inv_1_fwd(40*SEC, true);       
  inv_1_fwd(60*SEC, false);     
  inv_1_rev(60*SEC, true); 
  inv_1_rev(80*SEC, false);

    inv_1_fwd(100*SEC, true);       
  inv_1_fwd(110*SEC, false);     
  inv_1_rev(110*SEC, true); 
  inv_1_rev(120*SEC, false);
  
//
  inv_2_fwd(0*SEC, true); 
  inv_2_fwd(10*SEC, false);
  inv_2_rev(10*SEC, true);
  inv_2_rev(20*SEC, false);
  
   inv_2_fwd(50*SEC, true); 
  inv_2_fwd(70*SEC, false);
  inv_2_rev(70*SEC, true);
  inv_2_rev(90*SEC, false);
  
//
  inv_3_fwd(0*SEC, true); 
  inv_3_fwd(10*SEC, false);
  inv_3_rev(10*SEC, true);
  inv_3_rev(20*SEC, false);
  
  inv_3_fwd(60*SEC, true); 
  inv_3_fwd(80*SEC, false);
  inv_3_rev(80*SEC, true);
  inv_3_rev(100*SEC, false);
...
//
  ...
  inv_4_fwd(90*SEC, true); 
  inv_4_fwd(110*SEC, false);
  inv_4_rev(110*SEC, true);
  inv_4_rev(130*SEC, false);
  
  end_timeline(132*SEC); //
